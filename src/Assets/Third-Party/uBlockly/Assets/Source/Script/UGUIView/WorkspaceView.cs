...
namespace UBlockly.UGUI
{
    public class WorkspaceView : MonoBehaviour
    {
        ...
        public void ZoomInPanel() {
            if (codingPanel.transform.localScale.x < maxZoom) {
                codingPanel.transform.localScale += new Vector3(zoomIncrement, zoomIncrement, 0);
            }
        }

        public void ZoomOutPanel() {
            if (codingPanel.transform.localScale.x > minZoom) {
                codingPanel.transform.localScale -= new Vector3(zoomIncrement, zoomIncrement, 0);
            }
        }

        public int GetUsedBlocks() {
            return mBlockViews.Count;
        }
